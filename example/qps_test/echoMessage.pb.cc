...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_echoMessage_2eproto = {
  false, false, 81, descriptor_table_protodef_echoMessage_2eproto, "echoMessage.proto", 
  ...
  file_level_metadata_echoMessage_2eproto, file_level_enum_descriptors_echoMessage_2eproto, file_level_service_descriptors_echoMessage_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_echoMessage_2eproto_getter() {
  return &descriptor_table_echoMessage_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_echoMessage_2eproto(&descriptor_table_echoMessage_2eproto);
namespace qps_test {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "qps_test.EchoMessage.content"));
          CHK_(ptr);
...
void EchoMessage::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<EchoMessage *>(to)->MergeFrom(
      static_cast<const EchoMessage &>(from));
}
